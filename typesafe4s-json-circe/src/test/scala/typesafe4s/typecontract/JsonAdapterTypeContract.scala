...
import typesafe4s.circe.JsonEntry

// ============================================================================
// TYPED CONTRACT — spec: json-adapters (change: add-typesafe4s-sdk, spec 9/10)
//
// Gate 1 artifact. Module: typesafe4s-circe.
//
...
// for io.circe.Json could not honestly exist; the wrapper discharges the
...
private object JsonAdapterTypeContract {
  ...
  // the checked crossing — the only way a circe Json becomes a JsonEntry
  def witnessOf(value: io.circe.Json): Either[String, JsonEntry] =
    JsonEntry.of(value)
...
//   * `summon[StateEncoder[io.circe.Json]]` must NOT resolve — no
